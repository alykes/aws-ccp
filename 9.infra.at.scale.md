...
### Cloudformation  
- Declarative way off outlining your AWS infra  
- Cloudformation creates the resources in the right order  
...
Elastic Beanstalk is a **developer** centri view of deploying an application in AWS  
...
`Exam Tip` Whenever you hear orchestration of piplelines, think of AWS CodePipeline  
...
`CodePipeline`: Orchestrate the pipeline, build and deploy  
