...
- Cost Benefits:  
  - ${{\color{violet}{\textsf{Consolidated billing}}}}\$ across all accounts - single payment method  
  - Pricing benefits from ${{\color{violet}{\textsf{aggregated usage}}}}\$ (volume discounts for EC2, S3)  
  - ${{\color{violet}{\textsf{Pooling of reserved EC2 instances}}}}\$ for optimal savings  
- API is available to ${{\color{violet}{\textsf{automate AWS account creation}}}}\$    
- ${{\color{violet}{\textsf{Restrict account privileges using Sevice Control Policies (SCP)}}}}\$  
