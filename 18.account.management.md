...
- Cost Benefits:  
  - ${{\color{#974006}{\textsf{Consolidated billing}}}}\$ across all accounts - single payment method  
  - Pricing benefits from ${{\color{#974006}{\textsf{aggregated usage}}}}\$ (volume discounts for EC2, S3)  
  - ${{\color{#974006}{\textsf{Pooling of reserved EC2 instances}}}}\$ for optimal savings  
- API is available to ${{\color{#974006}{\textsf{automate AWS account creation}}}}\$    
- ${{\color{#974006}{\textsf{Restrict account privileges using Sevice Control Policies (SCP)}}}}\$  
