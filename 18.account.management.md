...
- Cost Benefits:  
  - ${{\color{cyan}{\textsf{Consolidated billing}}}}\$ across all accounts - single payment method  
  - Pricing benefits from ${{\color{cyan}{\textsf{aggregated usage}}}}\$ (volume discounts for EC2, S3)  
  - ${{\color{cyan}{\textsf{Pooling of reserved EC2 instances}}}}\$ for optimal savings  
- API is available to ${{\color{cyan}{\textsf{automate AWS account creation}}}}\$    
- ${{\color{cyan}{\textsf{Restrict account privileges using Sevice Control Policies (SCP)}}}}\$  
